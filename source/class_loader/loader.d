...
import app: method_info, field_info;
...
struct BootstrapLoader
{
    public:
        static ClassFile parse_class_file(const ubyte[] buffer) 
        {
            ...
            auto cf = ClassFile(magic, min_version, maj_version, const_pool_cnt, const_pool[0],
                                access_flags, this_class, super_class, interface_cnt, interfaces[0],
                                field_cnt, fields[0], methods_cnt, methods[0], attr_cnt, attributes[0]);
    ...
    private:
        static Tuple!(CP_INFO[], size_t) build_const_pool(const ubyte[] buffer, size_t pool_cnt, size_t start) 
        {
        ...
        static Tuple!(size_t[], size_t) build_interfaces_table(const ubyte[] buffer, size_t interface_cnt, size_t start)
        {
        ...
        static Tuple!(field_info[], size_t) build_fields_table(const ubyte[] buffer, size_t field_cnt, size_t start, CP_INFO[] pool)
        {
        ...
        static Tuple!(method_info[], size_t) build_method_table(const ubyte[] buffer, size_t method_cnt, size_t start, CP_INFO[] pool)
        {
        	method_info[] methods;
        ...
        static Tuple!(ATTR_INFO[], size_t) build_attributes_table(const ubyte[] buffer, size_t attr_cnt, size_t start, CP_INFO[] pool)
        {
